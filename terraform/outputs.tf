...
output "student_instance_1_ssh_key_public" {
  value = module.student_instance_1.tls_private_key.ssh_key_public
}
...
output "student_instance_2_ssh_key_public" {
  value = module.student_instance_2.tls_private_key.ssh_key_public
}
...
output "student_instance_3_ssh_key_public" {
  value = module.student_instance_3.tls_private_key.ssh_key_public
}
...
output "student_instance_4_ssh_key_public" {
  value = module.student_instance_4.tls_private_key.ssh_key_public
}
...
output "student_instance_5_ssh_key_public" {
  value = module.student_instance_5.tls_private_key.ssh_key_public
}
