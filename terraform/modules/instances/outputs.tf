...
output "student_instance_1_root_password" {
  value = module.student_instance_1.random8string.admin_pass.result
}
...
output "student_instance_4_root_password" {
  value = module.student_instance_4.random8string.admin_pass.result
}
...
output "student_instance_5_ssh_key_public" {
  value = module.student_instance_5.tls_private_key.public_key_openssh
}
